...
export class PhHullIntegrity extends HTMLElement {
  ...
  <style>
    ...
    .placeholder { font-size: 0.65rem; color: #6a7178; letter-spacing: 0.2em; padding: 0.5rem 0; text-align: center; }
    .systems-label { font-size: 0.65rem; letter-spacing: 0.2em; color: #6a7178; margin-top: 0.25rem; }
  </style>
