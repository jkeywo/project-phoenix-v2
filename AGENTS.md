...
npx playwright test                            # all 247 — the nightly's tier
npx playwright test comms-visiting-station     # ONE feature's deep specs
#   @core is 47 tests, one breadth test per feature area, tagged in the spec
...
#                dist/, across a 3-way matrix. TWO TIERS: @core (47 breadth
#                tests, one per feature area) on PRs and main pushes; the full
#                247 on the nightly, on workflow_dispatch, and on a PR labelled
