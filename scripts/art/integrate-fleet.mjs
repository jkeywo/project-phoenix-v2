...
const models={
  ...
  ship_harrow_cruiser:'dynasty_cruiser',ship_harrow_patrol:'dynasty_cruiser',ship_harrow_destroyer:'dynasty_destroyer',
...
for(const [entity,model] of Object.entries(models)){
  ...
  const accepted=[`assets/models/${model}.glb`,replacement];
  if(entity==='ship_harrow_destroyer')accepted.push('assets/models/dynasty_battleship.glb','assets/models/dynasty_battleship_recreated.glb');
  assert.ok(accepted.includes(before.mesh.model),entity+' unexpected existing model');
