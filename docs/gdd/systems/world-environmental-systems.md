...
Depth is earned when it gives another bridge officer a consequential decision within a mission. Phoenix does not simulate astronomical formation histories, walkable interiors or a galaxy merely to claim scale. A coarse wrapping planetary Orbital Mode is accepted but unscheduled; it uses normal planar controls and points of interest rather than terrain-following or atmospheric physics.
