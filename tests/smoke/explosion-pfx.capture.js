...
// Run it explicitly:
//
//   npx playwright test --config=playwright.capture.config.js explosion-pfx.capture.js --headed
//
...
// well within phaser range (matches tactical-fire-flow.spec.js's layout).
...
test('capture ship death explosion on a one-shot phaser kill', async ({ context }) => {
  ...
  // same technique as tactical-fire-flow.spec.js's NPC-hull-decreases test.
