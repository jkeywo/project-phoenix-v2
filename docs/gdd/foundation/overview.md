...
- terrain-following atmospheric or character-scale planetary exploration; Band C8's coarse wrapping Orbital Mode remains deliberately below that scope;
