...
| `gm-activity-feed.js` | Strict raw local Host Channel damage/destruction DTO; absolute repeat-preserving bounded reduction, oldest-first category/involved-identity filtering, render-site name localisation, and availability-checked links into the GM map's stable UUID selection |
