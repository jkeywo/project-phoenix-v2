...
use crate::shared::messages::{ClientMessage, Console, GamePhase, GameState, Player, ServerMessage};
...
mod tests {
    use super::*;
    use crate::shared::messages::{Console, GamePhase, GameState, Player};
    ...
    fn sim_state_does_not_disturb_lobby_model() {
        use crate::shared::messages::{SimSnapshot, ViewMode};
        let mut s = LobbyState::default();
