...
impl TorpedoSystem {
    ...
    /// timer for one torpedo — the torpedo is returned to the magazine when
    ...
    pub fn tick(
        ...
        // ── Auto-unload toward target_count ───────────────────────────────
        for i in 0..n_tubes {
            let tube = &self.tubes[i];
            if !matches!(
                tube.load_state,
