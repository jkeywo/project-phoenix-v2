...
pub use core::{
    ...
    plan_artillery_position, plan_fly_through_pass, plan_helm_travel, plan_recovery_orbit,
    resolve_objective_target, score_doctrine_pool, steer_toward, target_relative_motion,
    visible_entities, AiWorldEntity, ArtilleryPositionInput, FlyThroughLeg, FlyThroughPassInput,
    HazardAssessmentRaw, HazardContribution, ImpulseDecision, ImpulseDecisionInput,
    RecoveryOrbitInput, TargetRelativeMotion, WorldView, AVOIDANCE_BUFFER,
