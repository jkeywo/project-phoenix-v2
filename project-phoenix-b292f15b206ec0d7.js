...
export function set_config_request_callback(callback) {
    wasm.set_config_request_callback(addHeapObject(callback));
}
...
export function set_host_channel_callback(callback) {
    wasm.set_host_channel_callback(addHeapObject(callback));
}
...
export function set_message_callback(callback) {
    wasm.set_message_callback(addHeapObject(callback));
}
...
export function set_world_fetch_callback(callback) {
    wasm.set_world_fetch_callback(addHeapObject(callback));
}
...
export function wasm_cross_target_probe() {
    ...
    try {
        ...
        wasm.wasm_cross_target_probe(retptr);
...
export function wasm_delivery_stamp() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_delivery_stamp(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_export_file_name() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_export_file_name(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_ai_doctrine() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_ai_doctrine(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_console_latency() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_console_latency(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_damage_log() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_damage_log(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_debug_flags() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_debug_flags(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_debug_state() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_debug_state(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_entity_debug_state() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_entity_debug_state(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_entity_inspector() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_entity_inspector(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_scenario_state() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_scenario_state(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_get_station_activity() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_get_station_activity(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {boolean}
 */
export function wasm_is_debug_regions_enabled() {
    const ret = wasm.wasm_is_debug_regions_enabled();
    return ret !== 0;
}
...
export function wasm_load_config(path, toml_str) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(toml_str, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.wasm_load_config(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
export function wasm_load_world(path, toml_str, curated_ships) {
    try {
        ...
        const ptr1 = passStringToWasm0(toml_str, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayJsValueToWasm0(curated_ships, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        wasm.wasm_load_world(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export function wasm_peek_import(text) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.wasm_peek_import(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function wasm_perf_capture(scenario) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(scenario, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.wasm_perf_capture(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function wasm_prepare_import(text) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.wasm_prepare_import(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function wasm_prepare_resume(slot) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.wasm_prepare_resume(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred2_0 = r0;
        deferred2_1 = r1;
...
export function wasm_push_scenario_manifest(toml_str) {
    const ptr0 = passStringToWasm0(toml_str, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
...
export function wasm_push_sidecar_toml(path, toml_str) {
    ...
    const ptr1 = passStringToWasm0(toml_str, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    wasm.wasm_push_sidecar_toml(ptr0, len0, ptr1, len1);
}
...
export function wasm_receive_message(sender_token, json) {
    const ptr0 = passStringToWasm0(sender_token, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
...
export function wasm_select_ship(template_path) {
    const ptr0 = passStringToWasm0(template_path, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @param {boolean} on
 */
export function wasm_set_console_latency(on) {
    wasm.wasm_set_console_latency(on);
}
 ...
 */
export function wasm_set_debug_regions(enabled) {
    wasm.wasm_set_debug_regions(enabled);
}
...
export function wasm_set_log_entity(names) {
    const ptr0 = passStringToWasm0(names, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
...
export function wasm_simmath_battery() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_simmath_battery(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_snapshot_status() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_snapshot_status(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function wasm_take_exported_snapshot() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.wasm_take_exported_snapshot(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 */
export function wasm_toggle_ai_doctrine() {
    wasm.wasm_toggle_ai_doctrine();
}
 ...
 */
export function wasm_toggle_debug_damage() {
    wasm.wasm_toggle_debug_damage();
}
 ...
 */
export function wasm_toggle_debug_entities() {
    wasm.wasm_toggle_debug_entities();
}
 ...
 */
export function wasm_toggle_debug_overlay() {
    wasm.wasm_toggle_debug_overlay();
}
 ...
 */
export function wasm_toggle_debug_regions() {
    wasm.wasm_toggle_debug_regions();
}
 ...
 */
export function wasm_toggle_entity_inspector() {
    wasm.wasm_toggle_entity_inspector();
}
 ...
 */
export function wasm_toggle_scenario_state() {
    wasm.wasm_toggle_scenario_state();
}
 ...
 */
export function wasm_toggle_station_activity() {
    wasm.wasm_toggle_station_activity();
}
...
export function wasm_validate_stations(template_path, toml_str) {
    try {
        ...
        const ptr1 = passStringToWasm0(toml_str, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.wasm_validate_stations(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 106204, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_139533);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Array<any>"), NamedExternref("ResizeObserver")], shim_idx: 18041, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28038);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Array<any>")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_3);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Event")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_4);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("FocusEvent")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_5);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000007: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("KeyboardEvent")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_6);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000008: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("PageTransitionEvent")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_7);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000009: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("PointerEvent")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_8);
            return addHeapObject(ret);
        },
        __wbindgen_cast_000000000000000a: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("WheelEvent")], shim_idx: 18039, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28036_9);
            return addHeapObject(ret);
        },
        __wbindgen_cast_000000000000000b: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Option(NamedExternref("Blob"))], shim_idx: 18049, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28047);
            return addHeapObject(ret);
        },
        __wbindgen_cast_000000000000000c: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 18043, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_28041);
            return addHeapObject(ret);
        },
        __wbindgen_cast_000000000000000d: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 56267, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_75853);
            return addHeapObject(ret);
        },
        __wbindgen_cast_000000000000000e: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 97709, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_127496);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_28041(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_28041(arg0, arg1);
}

function __wasm_bindgen_func_elem_75853(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_75853(arg0, arg1);
}

function __wasm_bindgen_func_elem_127496(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_127496(arg0, arg1);
}

function __wasm_bindgen_func_elem_28036(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_3(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_3(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_4(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_4(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_5(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_5(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_6(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_6(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_7(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_7(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_8(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_8(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28036_9(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28036_9(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_28047(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_28047(arg0, arg1, isLikeNone(arg2) ? 0 : addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_139533(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_139533(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_28038(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_28038(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
