...
const editorModules = [
  ...
  'workshop-models', 'workshop-model-preview', 'workshop-preview', 'workshop-preview-runtime',
  ...
  'workshop-migration', 'workshop-diff', 'workshop-definitions', 'workshop-composition',
