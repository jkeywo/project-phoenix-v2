...
Current implementation orientation only. For intended design use
[`pasm/spec/`](../pasm/spec/); for planned work use GitHub PRDs and issues.
...
- [Helm Console](./entities/helm-console.md)
- [Navigation Console](./entities/navigation-console.md)
- [Editor](./entities/editor.md)

## Simulation and control

- [Ship Plugin](./concepts/ship-plugin.md)
...
- [Power Plugin](./concepts/power-plugin.md)
- [Damage and Repair Runtime](./concepts/damage-and-repair-intent.md)
- [Repair Plugin](./concepts/repair-plugin.md)
- [Weapons Runtime](./concepts/weapons-intent.md)
- [Weapons Plugin](./concepts/weapons-plugin.md)
- [Shields Runtime](./concepts/shields-intent.md)
- [Science Plugin](./concepts/science-plugin.md)
- [Modifier Coordination](./concepts/modifier-coordination.md)
- [Objectives](./concepts/objectives.md)
- [Red Alert Runtime](./concepts/red-alert-intent.md)
- [Asteroid Field](./concepts/asteroid-field.md)
- [Information Parity](./concepts/information-parity-audit.md)

## Client and presentation

- [Console UI Library](./concepts/console-ui-library.md)
...
- [Comms Panel](./concepts/comms-panel.md)
- [Comms Range](./concepts/comms-range.md)
- [Localisation](./concepts/localisation.md)
- [UI Materials](./concepts/ui-materials.md)

## Infrastructure and tooling

- [Networking](./concepts/networking.md)
- [Broadcaster Seam](./concepts/broadcaster-seam.md)
...
- [Native Host](./concepts/native-host.md) — the Windows authoritative host: fourth boot profile, native wgpu viewscreen, transport seam, local Ultralight Station panes, persistent controller profiles, host-reserved station screens, a private local GM, per-ship-class saved bridge layouts, and the guided acceptance kit for the whole bridge lobby on real monitors
