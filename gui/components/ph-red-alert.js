export class PhRedAlert extends HTMLElement {
  ...
  <style>
    ...
    .alert-btn.standby { background: #0e1117; border-color: #282c38; color: #6a7178; }
    .alert-btn.standby:hover:not(:disabled) { background: #161b24; color: #aab; }
    .alert-btn.active { background: #3a0a0a; border-color: #e0402c; color: #e0402c; text-shadow: 0 0 8px rgba(224,64,44,0.5); }
