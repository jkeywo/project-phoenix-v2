...
use crate::shared::messages::{ClientMessage, ServerMessage, ViewDirection, ViewMode, WorldData};
...
mod tests {
    use super::*;
    use crate::shared::messages::{AsteroidInfo, Console, GamePhase, GameState, Player, SimSnapshot};

    fn snap(red_alert: bool, view_mode: ViewMode) -> SimSnapshot {
        SimSnapshot { red_alert, view_mode, ship_x: 0.0, ship_z: 0.0, ship_yaw: 0.0, authorized_repair_console: None }
    }
