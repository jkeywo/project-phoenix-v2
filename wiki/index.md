...
- **[Modifier Coordination](./concepts/modifier-coordination.md)** — Single owner of `ShipModifiers` lifecycle; translator pattern for modifier sources; power as the first translator.
