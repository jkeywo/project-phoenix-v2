...
| `gm-knowledge-compare.js` | Selected-ship Truth/Crew Knowledge/Difference view using `gm_entity`, the `gm_station` fold and ordinary Sensors/Comms builders; contacts can differ through range/tag filters, while current shared Objectives/Comms inputs show equality |
