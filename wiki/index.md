...
- **[Issues #587-596 — PRD #581 Unified Ship Entity Model](./sources/prd-581-unified-ship-entity-model.md)** — In progress. Core structural work done (ShipPhysics per-entity, tick_ai_controllers deleted, AiControllerComponent empty marker, Ship marker on all ships, console handlers use LocalShip, hull dual-write bridge). Dual-write bridges remain for ShipState/ShipHullIntegrity/SystemBlackboards.
