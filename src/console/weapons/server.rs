...
pub(crate) use super::shared::{
    any_bank_accepts_human_input, any_bank_operates_ai, any_tactical_system_operates_ai,
    live_entity_xz, system_is_registered, tactical_authorized, BeamContext, ShooterState,
